...
i++ // 3 --> oovo ne bi trebalo nikada pisati samo u redu

console.log(i)
 
 // operatori increment i decrement
 // imaju dvojaku ulogu
 // prva je korištenje a druga uvećanje/umanjenje
...
i = 0
 ...
 // zna biti na razzgovorima za posao
...
const {prezime, ime, ...meniBitno} = polaznik
...
// . služi da pristupam svojstvima i metodama (funckijama) na objektima
